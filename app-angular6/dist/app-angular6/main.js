...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.getMovie = function (id) {
        var url = apiUrl + "/" + id;
...
/*!*******************************!*\
  !*** ./src/app/app.module.ts ***!
  \*******************************/
/*! exports provided: AppModule, routingComponents */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var appRoutes = [
    ...
    },
    {
        ...
        component: _movie_detail_movie_detail_component__WEBPACK_IMPORTED_MODULE_5__["MovieDetailComponent"],
...
var routingComponents = [_movie_movie_component__WEBPACK_IMPORTED_MODULE_4__["MovieComponent"], _movie_detail_movie_detail_component__WEBPACK_IMPORTED_MODULE_5__["MovieDetailComponent"]];
...
var MovieDetailComponent = /** @class */ (function () {
    function MovieDetailComponent(route, api) {
        this.route = route;
        this.api = api;
        this.movie = {};
    }
    ...
    MovieDetailComponent.prototype.getMovieDetails = function (id) {
        var _this = this;
        this.api.getMovie(id).subscribe(function (data) {
            console.log(data);
            _this.movie = data;
        });
    };
    MovieDetailComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"]])
...
/*!******************************************!*\
  !*** ./src/app/movie/movie.component.ts ***!
  \******************************************/
/*! exports provided: MovieComponent, MovieDataSource */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MovieComponent", function() { return MovieComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MovieDataSource", function() { return MovieDataSource; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var MovieDataSource = /** @class */ (function (_super) {
    __extends(MovieDataSource, _super);
    function MovieDataSource(api) {
        var _this = _super.call(this) || this;
        _this.api = api;
        return _this;
    }
    MovieDataSource.prototype.connect = function () {
        return this.api.getMovies();
    };
    MovieDataSource.prototype.disconnect = function () {
    };
